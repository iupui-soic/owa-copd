...
This repository contains the cpg copd OpenMRS Open Web App.
...
This will create a file called `cpgcopd.zip` file in the `dist` directory,
...
This will build and deploy the app to the `C:\Users\coachwhit317\AppData\Roaming\OpenMRS\owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "C:\Users\coachwhit317\AppData\Roaming\OpenMRS\owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "C:\Users\coachwhit317\AppData\Roaming\OpenMRS\owa",
  "APP_ENTRY_POINT": "https://gw151.iu.xsede.org/openmrs/owa/cpg_copd/index.html"
}
```
